...
func NewSystemIntake() models.SystemIntake {
	return models.SystemIntake{
		...
		ISSOName:                    null.StringFrom("Test ISSO"),
		TRBCollaboratorName:         null.StringFrom("Test TRB Collaborator"),
		OITSecurityCollaboratorName: null.StringFrom("Test OIT Collaborator"),
